...
Practice of Protecting Computer systems, Networks, Data from digital threats such as attacks, thefts and damage.
Essential for maintaining **Confidentiality, Integrity and Availability (CIA)** of Information.
...
* **Network Security**
  Focuses on protecting internal networks from intrusions and attacks
...
* **Cloud Security**
  Addresses security concerns related to the cloud, implementing measures to protect data stored in the cloud

* **Information Security**
  Protects data integrity and privacy both in transit and at rest, ensuring data is only accessible by authorised parties

---

## **4. Threat Actors and Attacks**
...
## **9. Logs, Telemetry and Detection Technologies**
